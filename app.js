...
const weather = (realdata) => {
    ...
    if (realdata.weather[0].main == 'Haze'||realdata.weather[0].main == 'Mist') {
        document.body.style.background="url(6.jpeg) no-repeat center center/cover";
    }

   else if( realdata.weather[0].main == 'Rain'||realdata.weather[0].main=='Drizzle') {
        document.body.style.background="url(5.jpeg) no-repeat center center/cover";
    }

   else if( realdata.weather[0].main == 'Snow') {
        document.body.style.background="url(7.jpeg) no-repeat center center/cover";
    }
  
    else if( realdata.weather[0].main == 'Clear') {
        document.body.style.background="url(3.jpeg) no-repeat center center/cover";
    }
    else if( realdata.weather[0].main == 'Clouds') {
        document.body.style.background="url(4.jpeg) no-repeat center center/cover";
    }
